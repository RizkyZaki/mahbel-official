...
let DT_COLUMNS = [
    ...
    },
    {
        data: function (row) {
            ...
            let urlCreateSub = "/dashboard/sub-locus/create/" + hashId;
            let urlEdit = "/dashboard/locus/edit/" + hashId;
            let urlDelete = "/dashboard/locus/delete/" + hashId;
                        ...
                        <div class="drodown">
                            ...
                            <div class="dropdown-menu dropdown-menu-start">
                                <ul class="link-list-opt no-bdr">
                                    <li> 
                                        <a href="${urlCreateSub}"> <em class="icon ni ni-plus"></em><span>Tambah Sub Lokus</span></a>
                                    </li>
                                    <li> 
