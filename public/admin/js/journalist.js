...
let DT_COLUMNS = [
    ...
    },
    {
        data: function (row) {
            ...
            let urlDetail = "/dashboard/journalist/detail/" + hashId;
            let urlPrint = "/dashboard/journalist/print/" + hashId;
            let urlEdit = "/dashboard/journalist/edit/" + hashId;
            let urlDelete = "/dashboard/journalist/delete/" + hashId;
            let urlAccEdit = "/dashboard/journalist/accept-request/" + hashId;
            let urlRejectEdit = "/dashboard/journalist/reject-request/" + hashId;
            let urlDetailEdit = "/dashboard/journalist/detail-request/" + hashId;
