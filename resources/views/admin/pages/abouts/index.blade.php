...
@section('content-admin')
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    ...
                                                                    <li><a href="javascript:void(0);" data-url="about"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Tentang</h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="form-label">Judul <small class="text-danger">*</small></label>
                            <input type="text" class="form-control" onkeyup="createTextSlug()" id="title"
    ...
    <div class="modal fade" tabindex="-1" id="change-modal">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Ubah Tentang</h5>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="form-label">Judul <small class="text-danger">*</small></label>
                            <input type="text" class="form-control" onkeyup="createTextSlugUpdate()" id="newTitle"
                                name="title" placeholder="Title">
                        </div>
                        <div class="form-group col-md-6">
                            <label class="form-label">Slug</label>
    ...
    @push('customJs')
        ...
        <script src="{{ asset('custom/js/master/about.js') }}"></script>
    @endpush
@endsection
